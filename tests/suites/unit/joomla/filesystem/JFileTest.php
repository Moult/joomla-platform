...
class JFileTest extends PHPUnit_Framework_TestCase
{
	...
	{
	    $this->assertEquals('foo.png', JFile::makeSafe('foo.png'));
	    $this->assertEquals('!@_$_^____.png', JFile::makeSafe('!@#$%^&*().png', true));
	    $this->assertEquals('¡¢£¤¥§.png', JFile::makeSafe('¡¢£¤¥§.png', true));
	    $this->assertEquals('ëþĞŦƍɏ⁁ᾗ▚♘✪⟐⢳.png', JFile::makeSafe('ëþĞŦƍɏ⁁ᾗ▚♘✪⟐⢳.png', true));
	}
